...
public class ChannelClose
{
		...
		throws Exception
	{
		...
		try {
			...
			println ("starting sleeper com.ceaser.thread");
			sleeper.start();

			println ("waiting for sleeper com.ceaser.thread to issue read...");
			Thread.sleep (1000);
	...
	// print output with a timestamp and the com.ceaser.thread name.
