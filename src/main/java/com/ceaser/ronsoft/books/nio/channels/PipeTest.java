...
/**
 * Test Pipe objects using a worker com.ceaser.thread.
 *
 * Created April, 2002
...
public class PipeTest
{
	...
	/**
	 * A worker com.ceaser.thread object which writes data down a channel.
	...
	private static class Worker extends Thread
	{
		...
		// com.ceaser.thread execution begins here
		public void run()
		{
			ByteBuffer buffer = ByteBuffer.allocate (100);
